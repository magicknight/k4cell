...
export const en = {
  ...
  intro:
    "Every one of these is read off a single finite object — four points, three colours, six links — set out in full in the next section but one. They are ordered by how well they stand up, not by how exciting they are: the first four are statements about the finite object that you can check without granting the framework anything, and the list gets more conditional as it goes down. Nothing here is a fit.",
  epigraph: {
  ...
  rows: [
    ...
    },
    {
      ...
      h3: "Can inflation happen without a field invented for it — and how does it stop?",
    ...
    },
    {
      ...
      h3: "What is the point of all of it: nineteen numbers, then one, then none?",
